...
class AddNote extends StatefulWidget {
  ...
  AddNote({this.isUpdate=false,this.id=-1, this.title='',this.desc='' ,this.createdAt='',});
  @override
            ...
            child: TextButton(onPressed: () async{
              ...
              if(titleController.text.isNotEmpty&&descController.text.isNotEmpty){
                if(widget.isUpdate){
                  ...
                  await context.read<NotesProvider>().updateNotes(NoteModel(
                    nID: widget.id,
                  ...
                  Navigator.pop(context);
                }else{context.read<NotesProvider>().addNote(NoteModel(
                    nTitle: titleController.text,
                    nDesc: titleController.text,
                    nCreatedAT: DateTime.now().microsecondsSinceEpoch.toString()));
                ...
                child:widget.isUpdate?Text("Update",style:TextStyle(color: Colors.white,)):Text("Save",style: TextStyle(color: Colors.white),),
          ),
          )],
      ),
      body: Padding(
